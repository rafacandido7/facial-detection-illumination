...
\IEEEauthorblockA{\textit{SUBSTITUIR: Departamento} \\
\textit{SUBSTITUIR: Nome da Institui\c{c}\~ao}\\
SUBSTITUIR: Brasília, Distrito Federal, Brasil \\
SUBSTITUIR: emails@instituicao.edu.br}
}
